...
const hardcodedReviews = {
  ...
  CS1250M: [
    { name: "Nico", comment: "All the pockets actually useful?? Let’s gooo." },
  ...
  CKS1700W: [
    { name: "Dana", comment: "Cable knit’s chunky and cute. Instant fave." }
  ],
  CS1250W: [
  ...
  RSS990W: [
    { name: "Kim", comment: "Stretchy and hugs just right. Crop is chef’s kiss." }
  ],
  AS3150U: [
...
//     { name: "Faye", comment: "No sweaty toes? I’m in love." }
  ...
  FS1490A: [
    { name: "Romeo", comment: "Wearing these makes me feel fast 😎" },
  ...
  LADC850A: [
    { name: "Kei", comment: "LA reppin’. Clean fit, structured brim." }
  ],
  NYYC850A: [
